...
return [
    ...
    'instagram'=> '<li><a target="_blank" href="https://www.instagram.com/" class="social-button :class" id=":id" title=":title" rel=":rel"><span class="fab fa-instagram"></span></a></li>',
    'pinterest' => '<li><a target="_blank" href=":url" class="social-button :class" id=":id" title=":title" rel=":rel"><span class="fab fa-pinterest"></span></a></li>',
];
