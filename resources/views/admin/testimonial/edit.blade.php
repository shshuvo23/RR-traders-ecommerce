                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="row align-items-center">
                                <div class="col-6">
                                    <h3 class="card-title">{{__('messages.testimonial.testimonial_edit')}}</h3>
                                </div>
                                <div class="col-6">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <img src="{{getProfile($testimonial->image)}}" alt="" width="100" height="100" class="mt-2">
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="order_id" id="order_id" value="{{ $testimonial->order_id }}" class="form-control"
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <select name="status" id="status" class="form-control">
                                                <option value="1" {{ $testimonial->status == '1' ? 'selected' : '' }}>{{__('messages.common.published')}}</option>
                                                <option value="0" {{ $testimonial->status == '0' ? 'selected' : '' }}>{{__('messages.common.unpublished')}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="details" id="details" class="form-control" placeholder="{{__('messages.common.message')}}"
                                                 cols="30" rows="10"> {{ $testimonial->details }} </textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="details_de" id="details_de" class="form-control" placeholder="{{__('messages.common.message')}}"
                                                 cols="30" rows="10"> {{ $testimonial->details_de }} </textarea>
                                        </div>
                                    </div>
