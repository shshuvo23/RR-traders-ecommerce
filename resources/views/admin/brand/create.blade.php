...
@section('title') {{ $title ?? 'Create Brand' }} @endsection
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" id="name" placeholder="Brand Name" class="form-control" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                        ...
                                        {{-- <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="orderby" id="orderby" class="form-control" placeholder="Order Number" required>
                                            </div>
                                        </div> --}}
                                        <div class="col-lg-12">
                                            <div class="form-group">
