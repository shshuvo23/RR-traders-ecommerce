...
@push('style')
<link rel="stylesheet" href="{{asset('assets/css/theme1.css')}}?v=3">
<style>
.st-btn {
    margin: 5px 0px;
}
...
<div class="template">
    <div class="banner mb-4 position-relative"
        style="background-image: url('{{asset($card->cover_image ?? 'assets/images/temmplate-bg2.jpg')}}');">
        <div class="user_pic">
            <img src="{{asset(getProfile($card->profile_image))}}" width="120"
                class="rounded-pill img-fluid" alt="">
        </div>
    </div>
        ...
        <div class="social_list mt-5 mb-5">
            <div class="row row-cols-4 row-cols-sm-4 gy-4">
                ...
                @if(isset($icons->website))
                    <div class="col mb-3 icon-wrapper" data-icon="website">
                        <div class="content text-center">
                ...
                @if(isset($icons->website_2))
                    <div class="col mb-3 icon-wrapper" data-icon="website_2">
                        <div class="content text-center">
                            <a href="{{$icons->website_2}}" target="_blank">
                                <div class="icon">
                                    <i class="fa fa-globe"></i>
                                </div>
                            </a>
                ...
                @if(isset($icons->facebook))
                    <div class="col mb-3 icon-wrapper" data-icon="facebook">
                        <div class="content text-center">
                ...
                @if(isset($icons->twitter))
                    <div class="col mb-3 icon-wrapper" data-icon="twitter">
                        <div class="content text-center">
                ...
                @if(isset($icons->linkedin))
                    <div class="col mb-3 icon-wrapper" data-icon="linkedin">
                        <div class="content text-center">
                ...
                @if(isset($icons->whatsapp))
                    <div class="col mb-3 icon-wrapper" data-icon="whatsapp">
                        <div class="content text-center">
                ...
                @if(isset($icons->pinterest))
                    <div class="col mb-3 icon-wrapper" data-icon="pinterest">
                        <div class="content text-center">
                ...
                @if(isset($icons->instagram))
                    <div class="col mb-3 icon-wrapper" data-icon="instagram">
                        <div class="content text-center">
                ...
                @if(isset($icons->calendly))
                    <div class="col mb-3 icon-wrapper" data-icon="spotify">
                        <div class="content text-center">
                ...
                @if(isset($icons->twitch))
                    <div class="col mb-3 icon-wrapper" data-icon="twitch">
                        <div class="content text-center">
                ...
                @if(isset($icons->xing))
                    <div class="col mb-3 icon-wrapper" data-icon="xing">
                        <div class="content text-center">
                ...
                @if(isset($icons->telegram))
                    <div class="col mb-3 icon-wrapper" data-icon="telegram">
                        <div class="content text-center">
            ...
            <div class="save_contact mt-4 mb-4 text-center">
                <a href="javascript:void(0)" class="btn btn-dark text-white  rounded-pill w-100" onclick="saveContacts()">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exchangeModalLabel">{{__('messages.card.exchange_contact')}} 1</h1>
                ...
                <form id="connect-form" action="{{route('user.card.query.submit')}}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="name" name="name" type="text"
                            placeholder="{{__('messages.placeholder.enter_name')}}" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="phone" name="phone" type="tel" required
                            placeholder="{{__('messages.placeholder.enter_phone')}}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" value="{{old('phone')}}">
                    </div>
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="job_title" name="job_title" type="text"
                            placeholder="{{__('messages.placeholder.enter_job_title')}}">
                    </div>
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="company_name" name="company_name" type="text"
                            placeholder="{{__('messages.placeholder.enter_company')}}">
                    </div>
                    <div class="mb-3">
                        <label for="message" class="form-label">{{__('messages.common.message')}} <span class="text-danger">*</span></label>
                        <textarea class="form-control" id="message" name="message"
                            style="height:80px;" cols="30" rows="5"
                            placeholder="{{__('messages.placeholder.enter_question')}}" required=""></textarea>
                    </div>
...
<div class="offcanvas offcanvas-bottom" tabindex="-1" id="offcanvasBottom" aria-labelledby="offcanvasBottomLabel">
    ...
    <div class="offcanvas-body small">
        <div class="text-center">
            ...
            <a data-bs-toggle="modal" href="#shareModalToggle" role="button" class="btn btn-primary rounded-pill px-5">
