...
@section('breadcrumb')
    <li class="breadcrumb-item active">{{__('messages.common.edit_card')}}</li>
@endsection
                ...
                <div class="card card-font">
                    <div class="card-header">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="">
                                <h4 class="card-title">{{__('messages.common.edit_your_card')}}</h4>
                            </div>
                            <div class="">
                                <a href="{{route('user.card.index')}}" class="btn btn-sm btn-primary btn-gradient">{{__('messages.common.back')}}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form action="{{route('user.card.update', $card->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="url_alias" class="form-control" placeholder="{{__('messages.common.card_url')}}" value="{{ $card->url_alias }}" 
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="cover_image" id="upload_cover" accept="image/*" class="form-control">
                                        <input type="hidden" name="cover_image_path" id="cover_image_path" value="{{$card->cover_image}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="profile_image" id="upload_image" accept="image/*" class="form-control">
                                        <input type="hidden" name="profile_image_path" id="profile_image_path" value="{{$card->profile_image}}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="" class="form-label">{{__('messages.common.first_name')}} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="first_name" value="{{$card->first_name}}" class="form-control cin preview_name" data-preview="preview_name"
                                        data-concat="preview_name" placeholder="{{__('messages.common.first_name')}}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="" class="form-label">{{__('messages.common.last_name')}} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="last_name" value="{{$card->last_name}}" class="form-control cin preview_name" data-preview="preview_name"
                                        data-concat="preview_name" placeholder="{{__('messages.common.last_name')}}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="" class="form-label">{{__('messages.common.email')}} <span
                                                class="text-danger">*</span></label>
                                        <input type="email" name="email" value="{{$card->email}}" class="form-control cin preview_email" data-preview="preview_email"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="" class="form-label">{{__('messages.common.phone')}} <span
                                                class="text-danger">*</span></label>
                                        <input type="tel" name="phone" value="{{$card->phone}}" class="form-control cin preview_phone" data-preview="preview_phone"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="" class="form-label">{{__('messages.common.designation')}} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="designation" value="{{$card->job_title}}" class="form-control cin preview_designation" data-preview="preview_designation"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="" class="form-label">{{__('messages.common.company_name')}} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="company_name" value="{{$card->company}}" class="form-control cin preview_company" data-preview="preview_company"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="" class="form-label">{{__('messages.common.address')}} <span
                                                class="text-danger">*</span></label>
                                        <input type="text" name="address" value="{{$card->location}}" class="form-control cin preview_address" data-preview="preview_address"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="url" name="website" value="{{$card->icons->website}}" class="form-control cin preview_website icon_in" 
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="url" name="facebook" value="{{$card->icons->facebook}}" placeholder="ex: https://www.facebook.com/venmeo.de"
                                        class="form-control icon_in" data-icon="facebook">
                                </div>
                                <div class="col-md-6 mb-2">
                                    <label for="twitter" class="form-label">{{__('messages.card.twitter')}}</label>
                                    <input type="url" name="twitter" value="{{$card->icons->twitter}}" placeholder="ex: https://www.twitter.com/venmeo.de"
                                        class="form-control icon_in" data-icon="twitter">
                                </div>
                                <div class="col-md-6 mb-2">
                                    <label for="linkedin" class="form-label">{{__('messages.card.linkedin')}}</label>
                                    <input type="url" name="linkedin" value="{{$card->icons->linkedin}}" placeholder="ex: https://www.linkedin.com/venmeo.de"
                                        class="form-control icon_in" data-icon="linkedin">
                                </div>
                                <div class="col-md-6 mb-2">
                                    <label for="whatsapp" class="form-label">{{__('messages.card.whatsapp')}}</label>
                                    <input type="tel" name="whatsapp" value="{{$card->icons->whatsapp}}" oninput="this.value = this.value.replace(/[^0-9.+]/g, '').replace(/(\..*?)\..*/g, '$1');"
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input type="url" name="pinterest" value="{{$card->icons->pinterest}}" placeholder="ex: https://www.pinterest.com/venmeo.de"
                                        class="form-control icon_in" data-icon="pinterest">
                                </div>
                                <div class="col-md-6 mb-2">
                                    <label for="instagram" class="form-label">{{__('messages.card.instagram')}}</label>
                                    <input type="url" name="instagram" value="{{$card->icons->instagram}}" placeholder="ex: https://www.instagram.com/venmeo.de"
                                        class="form-control icon_in" data-icon="instagram">
                                </div>
                                <div class="col-md-6 mb-2">
                                    <label for="calendly" class="form-label">{{__('messages.card.calendly')}}</label>
                                    <input type="text" name="calendly" value="{{$card->icons->calendly}}" placeholder="ex: {{__('messages.common.username')}}"
                                        class="form-control icon_in" data-icon="calendly">
                                </div>
                                <div class="col-md-6 mb-2">
                                    <label for="spotify" class="form-label">{{__('messages.card.spotify')}}</label>
                                    <input type="url" name="spotify" value="{{$card->icons->spotify}}" placeholder="ex: http://open.spotify.com/user/venmeo.de"
                                        class="form-control icon_in" data-icon="spotify">
                                </div>
                                <div class="col-md-6 mb-2">
                                    <label for="twitch" class="form-label">{{__('messages.card.twitch')}}</label>
                                    <input type="url" name="twitch" value="{{$card->icons->twitch}}" placeholder="ex: https://www.twitch.com/venmeo.de"
                                        class="form-control icon_in" data-icon="twitch">
                                </div>
                                <div class="col-md-6 mb-2">
                                    <label for="xing" class="form-label">{{__('messages.card.xing')}}</label>
                                    <input type="url" name="xing" value="{{$card->icons->xing}}" placeholder="ex: https://www.xing.com/venmeo.de"
                                        class="form-control icon_in" data-icon="xing">
                                </div>
                                <div class="col-md-6 mb-2">
                                    <label for="telegram" class="form-label">{{__('messages.card.telegram')}}</label>
                                    <input type="url" name="telegram" value="{{$card->icons->telegram}}" placeholder="ex: https://t.me/{{__('messages.common.username')}}"
                                        class="form-control icon_in" data-icon="telegram">
                                </div>
                                <div class="col-md-6 mb-2">
                                    <label for="paypal" class="form-label">{{__('messages.card.paypal')}}</label>
                                    <input type="text" name="paypal" value="{{$card->paypal_account}}" placeholder="{{__('messages.placeholder.your_paypal')}}"
                            ...
                            <div class="row card_theme">
                                <div class="col-sm-6 col-lg-4 col-xl-3">
                                    <label class="form-selectgroup-item flex-fill" for="theme1">
                                        <input class="form-input" type="radio" name="theme_id" id="theme1" value="1" {{$card->template_id == 1 ? 'checked' : ''}}>
                                ...
                                <div class="col-sm-6 col-lg-4 col-xl-3">
                                    <label class="form-selectgroup-item flex-fill" for="theme2">
                                        <input class="form-input" type="radio" name="theme_id" id="theme2" value="2" {{$card->template_id == 2 ? 'checked' : ''}}>
                                        <div class="form-selectgroup-label d-flex align-items-center">
                                            <div>
                            ...
                            <div class="col-12 text-center mt-4 mb-2">
                                <button type="submit" class="btn btn-success btn-sm">{{__('messages.card.update_card')}}</button>
                            </div>
                        </form>
                    </div>
                </div>
...
$(document).ready(function() {
    $('input[name="theme_id"]').on('change', function() {
        ...
        $.ajax({
            url: '{{ route("user.card.preview.template") }}',
            type: 'GET',
            data: { 
...
<script src="{{ asset('assets/js/croppie.js') }}?v=1.0.1"></script>
