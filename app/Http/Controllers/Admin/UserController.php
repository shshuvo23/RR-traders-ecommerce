...
class UserController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        $roles = Role::latest()->get();
        return view('admin.users.create', compact('settings', 'config', 'roles'));
    }
    ...
    public function passwordUpdate($id, Request $request)
    {
        ...
        try {
            ...
            $user->save();
            Toastr::success(__('messages.toastr.admin_password_success'), 'Success', ["positionClass" => "toast-top-center"]);
        } catch (\Throwable $th) {
            // dd($th);
    ...
    public function update($id, UpdateUserRequest $request)
    {
        ...
        try {
            ...
            Toastr::success(__('messages.toastr.admin_update_success'), 'Success', ["positionClass" => "toast-top-center"]);
        } catch (\Throwable $th) {
            // dd($th);
            Toastr::error(__('messages.toastr.admin_update_error'), 'Error', ["positionClass" => "toast-top-right"]);
            DB::rollBack();
            return back();
        }
    ...
    public function destroy($id){
        ...
        Toastr::success(trans('Admin Deleted Successfully!'), 'Success', ["positionClass" => "toast-top-center"]);
        return redirect()->back();
    }
